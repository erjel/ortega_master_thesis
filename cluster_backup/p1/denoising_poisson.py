...
if __name__ == '__main__':
    ...
    filepath= f"{path}/11_oct/checkpoints/p{order}_poisson_{var}_{num_classes}",
    ...
    np.save(f"{path}/11_oct/history/p{order}_poisson_{var}_{num_classes}.npy",np.array(list(history.history.values())))