...
if __name__ == '__main__':
    ...
    filepath= f"{path}/11_oct/checkpoints/u_deblurring_fourier_{var}_{option}_kernel{kernel_size}",
    ...
    np.save(f"{path}/11_oct/history/u_debluring_fourier_{var}_{option}_kernel{kernel_size}.npy",np.array(list(history.history.values())))