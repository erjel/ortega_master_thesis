...
if __name__ == '__main__':
    ...
    filepath= f"{path}/11_oct/checkpoints/poisson_{var}_{option}_kernel{kernel_size}",
    ...
    np.save(f"{path}/11_oct/history/poisson_{var}_{option}_kernel{kernel_size}.npy",np.array(list(history.history.values())))