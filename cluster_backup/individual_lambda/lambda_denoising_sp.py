...
if __name__ == '__main__':
    ...
    lamb_var = []
    for var in tqdm(np.arange(0.05,0.35,0.05)):
        er = []
    ...
    np.save(f'/gpfs/soma_fs/home/ortega/scripts/PeronaMalik/thesis/11_oct/individual_lambda/lambdas/sp_{option}.npy',lamb_var)