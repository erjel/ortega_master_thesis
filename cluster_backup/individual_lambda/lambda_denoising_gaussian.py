...
if __name__ == '__main__':
    ...
    lamb_var = []
    for var in tqdm(np.arange(0.05,3,0.15)):
        er = []
    ...
    np.save(f'/gpfs/soma_fs/home/ortega/scripts/PeronaMalik/thesis/11_oct/individual_lambda/lambdas/gaussian_{option}.npy',lamb_var)