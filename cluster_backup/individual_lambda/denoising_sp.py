...
if __name__ == '__main__':
    ...
    callbacks = [tf.keras.callbacks.ModelCheckpoint(
        filepath= f"{path}/11_oct/checkpoints/sp_{var}_{option}_kernel{kernel_size}",
    ...
    np.save(f"{path}/11_oct/history/sp_{var}_{option}_kernel{kernel_size}.npy",np.array(list(history.history.values())))