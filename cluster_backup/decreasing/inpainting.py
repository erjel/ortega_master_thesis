...
if __name__ == '__main__':
    ...
    callbacks = [tf.keras.callbacks.ModelCheckpoint(
        filepath= f"{path}/11_oct/checkpoints/dec_inpainting_{var}_{num_classes}",
    ...
    np.save(f"{path}/11_oct/history/dec_inpainting_{var}_{num_classes}.npy",np.array(list(history.history.values())))