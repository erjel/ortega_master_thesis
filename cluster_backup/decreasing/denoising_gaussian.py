...
if __name__ == '__main__':
    ...
    filepath= f"{path}/11_oct/checkpoints/dec_gaussian_{var}_{num_classes}",
    ...
    np.save(f"{path}/11_oct/history/dec_gaussian_{var}_{num_classes}.npy",np.array(list(history.history.values())))