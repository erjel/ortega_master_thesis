...
if __name__ == '__main__':
    ...
    filepath= f"{path}/11_oct/checkpoints/dec_deblurring_cartesian_{var}_{num_classes}",
    ...
    np.save(f"{path}/11_oct/history/dec_debluring_cartesian_{var}_{num_classes}.npy",np.array(list(history.history.values())))